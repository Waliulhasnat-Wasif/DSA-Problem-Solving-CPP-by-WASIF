...
public:
    ListNode* mergeNodes(ListNode* head) {
        ...
        while (reader != nullptr) {
            ...
            ListNode* toDelete = sumNode->next;
            while (toDelete != reader) {
            ...
            if (reader != nullptr) reader = reader->next;
...
int main() {
    cout << "--- Testing LeetCode 2181: Merge Nodes in Between Zeros ---\n\n";

    runTestCase({0, 1, 2, 0, 4, 5, 6, 0, 8, 9, 0}, "Test 01: Standard");
    runTestCase({0, 1, 2, 3, 0}, "Test 02: Standard");
    runTestCase({0, 1, 2, 3, 0, 5, 0, 6, 0, 2, 6, 8, 0}, "Test 03: Multiple & Single Values");
}