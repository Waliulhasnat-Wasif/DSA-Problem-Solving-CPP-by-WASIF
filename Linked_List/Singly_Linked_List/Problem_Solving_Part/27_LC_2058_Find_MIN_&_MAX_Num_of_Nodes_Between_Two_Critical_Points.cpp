...
int main()
{
    cout << "--- Testing LeetCode 2058: Find the Minimum and Maximum Number of Nodes Between Critical Points ---\n\n";

    runTestCase({3, 1}, "Example 1 (Less than 3 nodes)");
    runTestCase({5, 3, 1, 2, 5, 1, 2}, "Example 2 (Multiple critical points)");
    runTestCase({1, 3, 2, 2, 3, 2, 2, 2, 7}, "Example 3 (Adjacent identical values handled)");
    runTestCase({2, 3, 3, 2}, "Edge Case (No strict local maxima/minima due to duplicates)");
