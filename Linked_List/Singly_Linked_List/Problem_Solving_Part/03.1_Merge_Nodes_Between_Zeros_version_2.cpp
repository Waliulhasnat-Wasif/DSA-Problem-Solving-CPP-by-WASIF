...
int main()
{
    cout << "--- Testing special version of LeetCode 2181: Merge Nodes in Between Zeros ---\n\n";

    runTestCase({0, 1, 2, 0, 4, 5, 6, 0, 8, 9, 0}, "Test 01: Standard");
    runTestCase({0, 0, 0, 1, 2, 3, 0, 3, 0, 0}, "Test 02: Multiple Zeros at the beginning & the end");
    runTestCase({0, 0, 1, 2, 3, 0, 0, 5, 0, 0, 0, 6, 0, 2, 6, 8, 0, 0}, "Test 03: Multiple zeros at the beginning, in between & at the end");
    runTestCase({1, 2, 3, 0, 0, 5, 0, 0, 0, 6, 0, 2, 6, 8}, "Test 04: No zeros at the beginning & at the end");
}