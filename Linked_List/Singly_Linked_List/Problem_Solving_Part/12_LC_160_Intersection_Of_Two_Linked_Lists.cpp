...
void createIntersectedLists(const vector<int>& valsA, const vector<int>& valsB, int skipA, int skipB, ListNode*& headA, ListNode*& headB,
...
void runTestCase(const vector<int>& valsA, const vector<int>& valsB, int skipA, int skipB, const string& testName) {
    Solution sol;
    ...
    cout << "Output points to val: " << resultStr << " | Expected points to val: " << expectedStr;
