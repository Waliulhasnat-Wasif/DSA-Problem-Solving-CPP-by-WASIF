...
int main()
{
    ...
    runTestCase({9, 9, 9, 9, 9, 9, 9}, {9, 9, 9, 9}, "Example 3 (Different lengths with cascading carry)");
    runTestCase({1}, {9, 9, 9}, "Edge Case 1 (l1 much shorter than l2)");
    runTestCase({5}, {5}, "Edge Case 2 (Single digit resulting in carry expansion)");
