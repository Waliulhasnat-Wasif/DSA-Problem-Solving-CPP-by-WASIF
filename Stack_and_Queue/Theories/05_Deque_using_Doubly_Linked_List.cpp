...
public:
    ...
    Deque(Deque&& other) noexcept : head(other.head), tail(other.tail), currentSize(other.currentSize) {
        other.head = nullptr;
        other.tail = nullptr;
        other.currentSize = 0;
    }
...
int main() {
    try {
        ...
        cout << "dq2 Front: " << dq2.front() << ", dq2 Back: " << dq2.back() << endl;  // 1, 20
        ...
        cout << "dq2 Front remains: " << dq2.front() << " (Unaffected)" << endl;  // 1
