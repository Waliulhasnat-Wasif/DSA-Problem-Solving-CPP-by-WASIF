...
public:
    ...
    Queue(const Queue &other)
        : capacity(other.capacity), currentSize(other.currentSize), frontIndex(0), rearIndex(other.currentSize)
    {
        arr = new int[capacity];
    ...
    Queue(Queue &&other) noexcept
        : arr(other.arr), capacity(other.capacity), currentSize(other.currentSize),
    ...
    int back() const
    {
        ...
        // Calculate the logical last element's index considering circular wrap-around
