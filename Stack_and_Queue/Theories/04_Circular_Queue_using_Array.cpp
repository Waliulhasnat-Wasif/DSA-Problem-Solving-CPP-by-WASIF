...
public:
    ...
    Queue(const Queue& other) : capacity(other.capacity), currentSize(other.currentSize), frontIndex(0), rearIndex(other.currentSize) {
        arr = new int[capacity];
    ...
    Queue(Queue&& other) noexcept
        : arr(other.arr), capacity(other.capacity), currentSize(other.currentSize), frontIndex(other.frontIndex), rearIndex(other.rearIndex) {
...
int main() {
    try {
        ...
        cout << "q2 Size after move: " << q2.size() << " (Empty: " << (q2.empty() ? "Yes" : "No") << ")" << endl;
        ...
        cout << "q3 Size after move: " << q3.size() << " (Empty: " << (q3.empty() ? "Yes" : "No") << ")" << endl;
