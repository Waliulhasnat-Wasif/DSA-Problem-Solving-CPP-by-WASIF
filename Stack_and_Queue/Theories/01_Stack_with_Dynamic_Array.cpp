...
public:
  ...
  Stack(Stack&& other) noexcept
    ...
    // Nullify the source object to prevent its destructor from freeing the
    // memory
    other.arr = nullptr;
    other.capacity = 0;
    other.currentSize = 0;
  ...
  */
  ...
  // Handles BOTH Copy Assignment (by taking l-value) and Move Assignment (by
  // taking r-value) safely.
  Stack& operator=(Stack temp) {
    swap(*this, temp);
    return *this;
    // temp's destructor cleans up the old memory of 'this' when it goes out of
    // scope
  }
